...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 6:
            ...
            document.getElementById('noBtn').innerHTML = 'Yeri si dices que no, estaré muy triste';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 7:
            ...
            document.getElementById('noBtn').innerHTML = 'Yeri estaré muy triste';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 8:
            ...
            document.getElementById('noBtn').innerHTML = 'Yeri estaré muy muy muy triste';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 9:
            ...
            document.getElementById('noBtn').innerHTML = 'Yeri de veras estaré muy muy muy muy triste.';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
